...
class TempleteOne extends Component{
    render(){
        return(
            <div className="paragraph_container">
                <div className="para_main">
                    <div className="head_heart">
                        <h1>What is Photobiomodulation Therapy?</h1>
                    </div>
                    <p>
                        ...
                        (700 – 1100 nm)<a href="http://www.litecure.com/about-photobiomodulation/photobiomodulation-glossary/"> electromagnetic spectrum</a>. It is a nonthermal process involving endogenous chromophores eliciting
                        ...
                        immunomodulation, and promotion of wound healing and tissue regeneration.<a href="http://www.litecure.com/blog/2016/10/14/photobiomodulation-therapy-is-making-a-name-for-itself/"> The term photobiomodulation
                    ...
                    <p>The primary target (chromophore) for the process is the cytochrome c complex, which is found in the inner membrane of the
                        ...
                        that facilitates energy transfer within the cell. In addition to ATP, laser stimulation also produces free nitric oxide and
                        reactive oxygen species. Nitric oxide is a powerful vasodilator and an important cellular signaling molecule involved in many
                        physiological processes. Reactive oxygen species have been shown to affect many important physiological signaling pathways
                        including the inflammatory response. In concert, the production of these signaling molecules has been shown to induce growth
                        factor production, to increase cell proliferation and motility, and to promote extracellular matrix deposition and pro-survival
                        pathways. Outside the cell, nitric oxide signaling drives vasodilation, which improves microcirculation in the damaged tissue,
                        delivering oxygen, vital sugars, proteins, and salts while removing wastes.</p>
                </div>
            </div>
        )
    }
